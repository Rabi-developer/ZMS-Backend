...
namespace ZMS.Domain.Migrations
{
    ...
    [Migration("20260310230852_vourcherconvertedtostring")]
    partial class vourcherconvertedtostring
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IMS.Domain.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("a1a1a1a1-0000-1111-2222-333344445555"),
                            IsDefault = true,
                            IsDeleted = false,
                            Name = "Owner",
                        ...
                        new
                        {
                            Id = new Guid("4b060397-f167-419e-a368-402bb48877c8"),
                            IsDefault = true,
                            IsDeleted = false,
                            Name = "User",
                            NormalizedName = "USER"
            ...
            modelBuilder.Entity("IMS.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1e5a9719-100c-4b1a-a61b-b396c0e2eed9",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJINCeC6DI78RvT5X9TuqSosRN3JxJqVDQFpi8KYzuupJSsdTWzuX+5I+E7GgkAghA==",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 121,
                            ClaimType = "Hotel",
                            ClaimValue = "Read,Create,Update,Execute,Delete",
                            RoleId = new Guid("a1a1a1a1-0000-1111-2222-333344445555")
                        },
                        new
                        {
                            Id = 131,
                        ...
                        new
                        {
                            ...
                            ClaimType = "Room",
                            ClaimValue = "Read",
                            RoleId = new Guid("4b060397-f167-419e-a368-402bb48877c8")
                        },
                        new
                        {
                            Id = 345,
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.AccountOpeningBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("AccountOpeningNo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AccountOpeningNo"));
                    ...
                    b.ToTable("AccountOpennigBalances");
                });

            modelBuilder.Entity("ZMS.Domain.Entities.AccountOpeningBalanceEntry", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("AccountOpeningBalanceId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AccountOpeningBalanceId");

                    b.ToTable("AccountOpeningBalanceEntry");
                });
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.BiltyPaymentInvoice", b =>
                {
                    ...
                    b.ToTable("BiltyPaymentInvoice");
                });

            modelBuilder.Entity("ZMS.Domain.Entities.BiltyPaymentInvoiceLine", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<float?>("AmountCharges")
                        .HasColumnType("real");

                    b.Property<Guid?>("BiltyPaymentInvoiceId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsAdditionalLine")
                        .HasColumnType("bit");

                    b.Property<float?>("Munshayana")
                        .HasColumnType("real");

                    b.Property<string>("NameCharges")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("BiltyPaymentInvoiceId");

                    b.ToTable("BiltyPaymentInvoiceLine");
                });
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.Consignment", b =>
                {
                    ...
                    b.Property<string>("CreditAllowed")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.OpeningBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("OpeningNo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OpeningNo"));
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.OpeningBalanceEntry", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.PaymentABL", b =>
                {
                    ...
                    b.Property<string>("AdvancedDate")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.VoucherDetail", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("Credit1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Credit2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CurrentBalance1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CurrentBalance2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Debit1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Debit2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid?>("EntryVoucherId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("Narration")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProjectedBalance1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProjectedBalance2")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.HasIndex("EntryVoucherId");
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.AccountOpeningBalanceEntry", b =>
                {
                    b.HasOne("ZMS.Domain.Entities.AccountOpeningBalance", null)
                        .WithMany("AccountOpeningBalanceEntrys")
                        .HasForeignKey("AccountOpeningBalanceId")
                        .OnDelete(DeleteBehavior.Restrict);
                });

            modelBuilder.Entity("ZMS.Domain.Entities.BiltyPaymentInvoiceLine", b =>
                {
                    b.HasOne("ZMS.Domain.Entities.BiltyPaymentInvoice", null)
                        .WithMany("Lines")
                        .HasForeignKey("BiltyPaymentInvoiceId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.OpeningBalanceEntry", b =>
                {
                    b.HasOne("ZMS.Domain.Entities.OpeningBalance", null)
                        .WithMany("OpeningBalanceEntrys")
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.VoucherDetail", b =>
                {
                    b.HasOne("ZMS.Domain.Entities.EntryVoucher", null)
                        .WithMany("VoucherDetails")
                        .HasForeignKey("EntryVoucherId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.AccountOpeningBalance", b =>
                {
                    b.Navigation("AccountOpeningBalanceEntrys");
                });
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.OpeningBalance", b =>
                {
                    b.Navigation("OpeningBalanceEntrys");
                });
