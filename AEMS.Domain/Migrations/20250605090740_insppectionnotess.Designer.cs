...
namespace IMS.Domain.Migrations
{
    ...
    [Migration("20250605090740_insppectionnotess")]
    partial class insppectionnotess
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IMS.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4cd83f92-1138-4217-80b4-e035be8cb21f",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEPYR2UmoJLhGq4HUbJxgPCDhNZ2a02FXxVlG+uQCriXvMCzwgZ/iPYG7Ys7LrQfqoA==",
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.InspectionContract", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.InspectionNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.InspectionContract", b =>
                {
                    b.HasOne("ZMS.Domain.Entities.InspectionNote", "InspectionNote")
                        .WithMany("RelatedContracts")
                        .HasForeignKey("InspectionNoteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("InspectionNote");
                });
