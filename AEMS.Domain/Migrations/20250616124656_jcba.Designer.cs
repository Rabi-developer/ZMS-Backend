...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IMS.Domain.Entities.AdditionalInfo", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("IMS.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0f02c19f-a14d-41d1-a0fd-336e2902e2f4",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEAzxjenO76krgO4T7Pjn9Q6spSJ0uKuu7uD0IpBRhK4A/wONRfw/Bgeb4SrzslbtIw==",
            ...
            modelBuilder.Entity("IMS.Domain.Entities.BuyerDeliveryBreakup", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BuyerDeliveryBreakup");
                });
            ...
            modelBuilder.Entity("IMS.Domain.Entities.CommisionInfo", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IMS.Domain.Entities.Contract", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("FinalSubOptions")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SelvegeWeave")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("IMS.Domain.Entities.ConversionContractRow", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IMS.Domain.Entities.DietContractRow", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IMS.Domain.Entities.MultiWidthContractRow", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IMS.Domain.Entities.SampleDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("SampleDeliveredDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("IMS.Domain.Entities.SellerDeliveryBreakup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SellerDeliveryBreakup");
                });
            ...
            modelBuilder.Entity("IMS.Domain.Entities.AdditionalInfo", b =>
                {
                    b.HasOne("IMS.Domain.Entities.SampleDetail", "SampleDetail")
            ...
            modelBuilder.Entity("IMS.Domain.Entities.BuyerDeliveryBreakup", b =>
                {
                    b.HasOne("IMS.Domain.Entities.Contract", "Contract")
            ...
            modelBuilder.Entity("IMS.Domain.Entities.CommisionInfo", b =>
                {
                    b.HasOne("IMS.Domain.Entities.ConversionContractRow", null)
                        .WithMany("CommisionInfo")
                        .HasForeignKey("ConversionContractRowid")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("IMS.Domain.Entities.DietContractRow", null)
                        .WithMany("CommisionInfo")
                        .HasForeignKey("DietContractRowid")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("IMS.Domain.Entities.MultiWidthContractRow", null)
                        .WithMany("CommisionInfo")
            ...
            modelBuilder.Entity("IMS.Domain.Entities.Contract", b =>
                {
                    b.HasOne("IMS.Domain.Entities.Buyer", "Buyer")
                        .WithMany()
                        .HasForeignKey("BuyerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("IMS.Domain.Entities.Seller", "Seller")
                        .WithMany()
            ...
            modelBuilder.Entity("IMS.Domain.Entities.ConversionContractRow", b =>
                {
                    b.HasOne("IMS.Domain.Entities.Contract", "Contract")
                        .WithMany("ConversionContractRows")
                        .HasForeignKey("ContractId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("IMS.Domain.Entities.MultiWidthContractRow", b =>
                {
                    b.HasOne("IMS.Domain.Entities.Contract", "Contract")
                        .WithMany("MultiWidthContractRows")
                        .HasForeignKey("ContractId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("IMS.Domain.Entities.Contract", b =>
                {
                    ...
                    b.Navigation("ConversionContractRows");

                    b.Navigation("DietContractRows");

                    b.Navigation("MultiWidthContractRows");
