...
namespace IMS.Domain.Migrations
{
    ...
    [Migration("20250617012810_newcontractentitytable")]
    partial class newcontractentitytable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IMS.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0f9a5f52-ba25-47f5-87e3-9265bb0711f7",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEI4KnhoOABN/00iPDSlgm6RhWg9oQE74tDNcwR5kQW0VGMB3zqk9aL67ikvoYgiEtg==",
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.DietContractRowList", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.MultiWidthContractRowInfo", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("MultiWidthContractRowInfo");
                });
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.MultiWidthContractRowInfo", b =>
                {
                    b.HasOne("ZMS.Domain.Entities.MultiWidthContractRow", null)
                        .WithMany("MultiWidthContractRowInfo")
                        .HasForeignKey("MultiWidthContractRowid")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("ZMS.Domain.Entities.DietContractRow", b =>
                {
                    ...
                    b.Navigation("DietContractRowList");
                });
